...
Fifa22 = pd.read_csv('/Users/alejandroquintero/Documents/Fifa2022.csv')
...
add_bg_from_local('/Users/alejandroquintero/Documents/Final_Proyect/campo.jpg')
...
# Set threshold for matching ratio
#threshold = 0.3
...
with col1:
    st.markdown(f"<div style='text-align: center;'><img src='{chosen_player_image}' width='215'></div>", 
                unsafe_allow_html=True)
    st.markdown(f"<div style='text-align: center;'><img src='{chosen_player_logo}' width='100'></div>", 
                unsafe_allow_html=True)
    st.markdown(f"<div style='text-align: center;'><img src='{chosen_player_nationality}' width='100'></div>", 
                unsafe_allow_html=True)

with col2:
    for attribute in ['shooting', 'passing', 'dribbling', 'defending', 'physic']:
        if attribute == 'shooting':
            st.image('/Users/alejandroquintero/Downloads/shooting-removebg-preview.png', width=30)
        elif attribute == 'physic':
            st.image('/Users/alejandroquintero/Downloads/physic-removebg-preview.png', width=30)
        elif attribute == 'dribbling':
            st.image('/Users/alejandroquintero/Downloads/dribling-removebg-preview.png', width=30)
        elif attribute == 'defending':
            st.image('/Users/alejandroquintero/Downloads/defense-removebg-preview.png', width=30)
        elif attribute == 'passing':
            st.image('/Users/alejandroquintero/Downloads/passing-removebg-preview.png', width=30)
...
closest_player_index, _ = pairwise_distances_argmin_min(player_attributes.values.reshape(1, -1), X)


# Input fields for the age range
...
# Filter the dataset for the age range
age_filtered = Fifa22[(Fifa22['age'] >= min_age) & (Fifa22['age'] <= max_age)]

# Get the indices of players in the same cluster as the chosen player, after applying the age filter
...
same_cluster_players = age_filtered.loc[same_cluster_indices, ["long_name", "club_name", "club_logo_url", "nation_flag_url", "player_face_url", "wage_eur", "value_eur", "shooting", "passing", "dribbling", "defending", "physic"]]
